/**
 * <voxl_app_figure_eight.h>
 *
 * @brief      Defines fields and callback functions for a generic figure eight
 *             app for VOXL.
 *
 *
 * @author     Michael Zeng
...
#ifndef VOXL_APP_FIGURE_EIGHT_H
#define VOXL_APP_FIGURE_EIGHT_H
...
/**
 * @brief     Add all setpoints in figure 8 to queue.
 */
void add_figure_eight_to_queue(void);
